...
namespace LibSpace_Aspnet.Data.Migrations
{
    ...
    [Migration("20241202100541_Updated_02_12_2024")]
    partial class Updated_02_12_2024
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LibSpace_Aspnet.Models.AspNetRole", b =>
                {
            ...
            modelBuilder.Entity("LibSpace_Aspnet.Models.AspNetUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("LibSpace_Aspnet.Models.AspNetUserClaim", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LibSpace_Aspnet.Models.AspNetUserLogin", b =>
                {
            ...
            modelBuilder.Entity("LibSpace_Aspnet.Models.AspNetUserToken", b =>
                {
                    b.Property<string>("UserId")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("AspNetUserRole", b =>
                {
                    b.HasOne("LibSpace_Aspnet.Models.AspNetRole", null)
                        .WithMany()
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("LibSpace_Aspnet.Models.AspNetUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("LibSpace_Aspnet.Models.AspNetRoleClaim", b =>
                {
                    b.HasOne("LibSpace_Aspnet.Models.AspNetRole", "Role")
            ...
            modelBuilder.Entity("LibSpace_Aspnet.Models.AspNetUserClaim", b =>
                {
                    b.HasOne("LibSpace_Aspnet.Models.AspNetUser", "User")
